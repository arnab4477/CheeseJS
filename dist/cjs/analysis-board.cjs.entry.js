...
const chessboard = require('./chessboard-8b54463f.js');
require('./BoardTypes-d378026b.js');
...
const createPawnPromotionHtmlElement = (rank) => {
  ...
  const whitePromotionHtml = `<div class='promotion-list'>
       <img id="Q" alt='white queen' class="piece promoting-piece" src=${chessboard.pieceImages.Q}>
       <img id="R" alt='white rook' class="piece promoting-piece" src=${chessboard.pieceImages.R}>
       <img id="B" alt='white bishop' class="piece promoting-piece" src=${chessboard.pieceImages.B}>
       <img id="N" alt='white knight' class="piece promoting-piece" src=${chessboard.pieceImages.N}>
     </div>`;
  const blackPromotionHtml = `<div class='promotion-list'>
      <img id="n" alt='black knight' class="piece promoting-piece" src=${chessboard.pieceImages.n}>
      <img id="b" alt='black bishop' class="piece promoting-piece" src=${chessboard.pieceImages.b}>
      <img id="r" alt='black rook' class="piece promoting-piece" src=${chessboard.pieceImages.r}>
      <img id="q" alt='black queen' class="piece promoting-piece" src=${chessboard.pieceImages.q}>
     </div>`;
...
class Validator {
  constructor() {
    ...
    this.boardMap = chessboard.fenToBoardMap();
...
const AnalysisBoard = class {
  ...
  componentDidLoad() {
    ...
    this.analysisBoardContainer.innerHTML = chessboard.generateChessBoard(this.light, this.dark, 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR');
  ...
  render() {
    return (index.h("div", { ref: (el) => (this.analysisBoardContainer = el), id: "analysis-board-container" }));
  }
};
AnalysisBoard.style = analysisBoardCss;

exports.analysis_board = AnalysisBoard;
