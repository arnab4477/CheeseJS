...
const ChessBoard = class {
  ...
  componentDidLoad() {
    ...
    this.chessBoardContainer.innerHTML = chessboard.generateChessBoard(this.light, this.dark, this.fen);
  ...
  render() {
    return (index.h("div", { ref: (el) => (this.chessBoardContainer = el), id: "chess-board-container" }));
  }
};
ChessBoard.style = chessBoardCss;

exports.chess_board = ChessBoard;
