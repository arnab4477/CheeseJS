 ...
 */
export const isEnPassant = (destFile, originRank, destRank, color, boardMap) => {
  if (color === 'w') {
...
export const getEnPassantSquare = (square, piece, documentHTML) => {
...
export const isCastle = (origin, dest, color, boardMap, canWhiteCastleKingSide, canWhiteCastleQueenSide, canBlackCastleKingSide, canBlackCastleQueenSide) => {
  if (color === 'w') {
    if (origin !== 'e1' ||
 ...
 * as Element
 */
export const getCastlingSquares = (piece, dest, documentHTML) => {
  let KingsOrigin;
  let KingsDest;
  let RooksOrigin;
  let RooksDest;
 ...
 */
export const isPromotion = (color, destRank) => {
